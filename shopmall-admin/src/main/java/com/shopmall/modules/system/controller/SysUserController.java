...
import com.shopmall.modules.system.domain.vo.UserPassVo;
...
import com.shopmall.pagehandle.utils.PageUtil;
...
//    }
    ...
    public ResponseEntity <Object> create(@Validated @RequestBody User resources){
        ...
        // 默认密码 123456
        resources.setPassword(passwordEncoder.encode(ShopConstants.SHOPMALL_DEFAULT_PWD));
    ...
    public ResponseEntity <Object> delete(@RequestBody Set<Long> ids){
        ...
        for (Long id : ids) {
            ...
            if (currentLevel > optLevel) {
                throw new RequestException("角色权限不足，不能删除：" + userService.findByName(SecurityUtils.getUsername()).getUsername());
            }
        }
