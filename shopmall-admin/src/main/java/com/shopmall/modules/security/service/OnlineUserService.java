package com.shopmall.modules.security.service;
...
import com.shopmall.utils.EncryptUtils;
...
public class OnlineUserService {
    ...
    public List<OnlineUser> getAll(String filter, int type) {
        ...
        if (type == 1) {
            keys = redisUtils.scan(ShopConstants.APP_LOGIN_USER + "*");
        } else {
    ...
    public void kickOutT(String key) throws Exception {
        ...
        String keyt = ShopConstants.APP_LOGIN_USER + split[0] + StrUtil.COLON + EncryptUtils.desDecrypt(split[1]);
        redisUtils.del(keyt);
