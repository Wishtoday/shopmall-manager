package com.shopmall.logging.aspect;

import com.shopmall.logging.domain.Log;
import com.shopmall.logging.service.LogService;
import com.shopmall.utils.RequestHolder;
...
public class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.shopmall.logging.aop.Log)")
